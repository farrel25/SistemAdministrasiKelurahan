...
class InfoIdentityController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('dashboard.info_kelurahan.identitas_kelurahan.identitas'/*, compact('categories')*/);
    }
    ...
    // {
    //     $categories = ArticleCategory::get();
    //     return view('dashboard.info_kelurahan.identitas_kelurahan.identitas-tambah'/*, compact('categories')*/);
    // }
    ...
    {
        return view('dashboard.info_kelurahan.identitas_kelurahan.identitas-edit'/*, compact('articleCategory')*/);
    }
