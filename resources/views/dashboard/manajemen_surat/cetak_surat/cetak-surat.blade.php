        ...
        <div class="main-card mb-3 card">
            <div class="card-header">Cetak Surat
                <div class="btn-actions-pane-right ">
                    <a type="button" class="btn btn-lg btn-focus btn-sm text-white font-weight-normal " href="#">+ Tambah Data </a>
                </div>
            </div>
                ...
                <table class="align-middle mb-0 table table-borderless table-striped table-hover p-5">
                    <thead>
                        <tr>
                            ...
                            <th class=" text-center">Layanan Administrasi Surat</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class=" text-center">
                                <a type="button" class="btn btn-sm btn-alternate text-white font-weight-normal " href="buat-cetak-surat"><i class="fas fa-edit border-right pr-1"></i> Buat Surat </a>
                            </td>
                            <td class=" text-center">#</td>
                            <td class=" text-center">#</td>
                            <td class=" text-center">#</td>
