@extends('dashboard.layouts.master', ['title' => "Tambah Surat Keluar"])
...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Tambah Surat Keluar
                <div class="page-title-subheading">Surat Keluar / Tambah Surat Keluar
                </div>
            </div>
        </div>
...
<div class="tab-content">
    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 class="card-title">Tambah Surat Keluar</h5>
                <hr>
                <form class="">
                    ...
                    <button class="mt-2 btn btn-primary">Tambah Surat Keluar</button>
