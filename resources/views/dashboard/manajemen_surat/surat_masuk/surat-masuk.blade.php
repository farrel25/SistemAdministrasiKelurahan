...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Surat Masuk
                <div class="page-title-subheading">Surat Masuk
                </div>
            </div>
        </div>
        ...
        <div class="main-card mb-3 card">
            <div class="card-header">Tabel Surat Masuk
                <div class="btn-actions-pane-right ">
                    ...
                    <a type="button" class="btn btn-lg btn-focus btn-sm text-white m-1 mb-2 mt-2 font-weight-normal btn-responsive" href="tambah-surat-masuk">+ Tambah Surat Masuk</a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td class=" text-center">
                                <div class="btn-group-sm btn-group">
                                    <a href="edit-surat-masuk" class="btn btn-primary" data-toggle="tooltip" title="Edit Surat Masuk" data-placement="bottom"><i class="fas fa-edit"></i></a>
                                    <a href="#" class="btn btn-danger" data-toggle="tooltip" title="Hapus Surat Masuk" data-placement="bottom"><i class="fas fa-trash-alt"></i></a>
                                    <a href="#" class="btn btn-alternate text-white" data-toggle="tooltip" title="Cetak Surat Masuk" data-placement="bottom"><i class="fas fa-print"></i></a>
                                </div>
                            </td>
                            <td class=" text-center">#</td>
                            <td class=" text-center">#</td>
