@extends('dashboard.layouts.master', ['title' => "Tambah Surat Masuk"])
...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Tambah Surat Masuk
                <div class="page-title-subheading">Surat Masuk / Tambah Surat Masuk
                </div>
            </div>
        </div>
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <form class="">
                    ...
                    <button class="mt-2 btn btn-primary">Tambah Surat Masuk</button>
