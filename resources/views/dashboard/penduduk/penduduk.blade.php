...
<div class="row">
    ...
    <div class="col-md-4 col-lg-4 mb-3 ">
        <div class=" row d-flex">
            <div class="col-6">
                <button type="button " class="btn btn-lg btn-block btn-danger text-white font-weight-bold  shadow ">
                    <i class="fas fa-file-pdf fa-2x"></i>
                </button>
            </div>
            <div class="col-6">
                <a href="{{ route('penduduk-export-excel') }}"
                    class="btn btn-lg btn-block btn-success text-white font-weight-bold  shadow ">
        ...
        <div class="main-card mb-3 card">
            <div class="card-header">Penduduk
                ...
                <div class="btn-actions-pane-right ">
                    ...
                    <a type="button" class="btn btn-lg btn-focus btn-sm text-white font-weight-normal ml-3"
