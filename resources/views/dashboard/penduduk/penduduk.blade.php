    ...
    <div class="row">
                        ...
                        <div class="widget-content-wrapper">
                            ...
                            <div class="widget-content-right w-100">
                                <div class="progress-bar-xs progress">
                                    <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="{{ number_format($activePercentage, 2) }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ number_format($activePercentage, 2) }}%;">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-md-4 col-lg-4 mb-3 ">
            <div class=" row d-flex">
                <div class="col-6">
                    <button id="delete" type="button " class="btn btn-lg btn-block btn-danger text-white font-weight-bold  shadow ">
                                ...
                                <tr>
                                    ...
                                    <td class=" text-center">
                                        <div class="btn-group-sm btn-group">
                                            <a href="{{ route('penduduk-edit', $villager->nik) }}" class="btn btn-primary" data-toggle="tooltip" title="Edit Data" data-placement="bottom">
                                                <i class="fas fa-edit">
                                                </i>
                                            </a>
                                            <form id="delete-form" action="{{ route('penduduk-delete', $villager->nik) }}" method="post">
                                                @csrf
                                                @method('delete')
                                                <button type="submit" class="btn btn-danger delete" data-toggle="tooltip" title="Hapus Data" data-placement="bottom">
                                                    <i class="fas fa-trash-alt"></i>
                                                </button>
                                            </form>

                                            <a href="{{ route('penduduk-detail', $villager->nik) }}" class="btn btn-warning text-white" data-toggle="tooltip" title="Detail Data" data-placement="bottom"><i class="fas fa-info-circle"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
